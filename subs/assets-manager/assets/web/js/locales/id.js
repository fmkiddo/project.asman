...
$(document).ready (function () {
	$doclocale = {
		...
		'pages': {
			...
			'{37}': 'Tentang',
			'{38}': 'Halo',
			'{39}': 'Pengaturan Sistem',
			'{40}': 'Pemeliharaan'
		},
		'contents': {
			'index': {
				'{0}': 'Jumlah Kuantitas Terdaftar',
				'{1}': 'Jumlah Jenis Aset Terdaftar',
				'{2}': 'Permintaan Menunggu Keputusan',
				'{3}': 'Total Aset Dalam Perjalanan',
				'{4}': 'Aset Dalam Perjalanan',
				'{5}': 'Kode',
				'{6}': 'Deskripsi',
				'{7}': 'Lokasi Awal',
				'{8}': 'Sublokasi Awal',
			...
			'asset-service': {
				...
				'{9}': 'Respon Oleh',
				'{10}': 'Deskripsi',
				'{11}': 'Periode Pemeliharaan',
				'{12}': 'Tgl. Pemeliharaan',
				'{13}': 'Status',
				'{14}': 'PIC',
				'{15}': 'Pemeliharaan Baru',
				'{16}': 'Kode Dokumen',
				'{17}': 'Lokasi Aset',
				'{18}': '--- Pilih Lokasi ---',
				'{19}': 'Sublokasi Aset',
				'{20}': 'Aset Terdaftar',
				'{21}': 'Tipe Pemeliharaan',
				'{22}': 'Sesuai Permintaan',
				'{23}': 'Pemeliharaan Rutin',
				'{24}': 'Daftarkan Jadwal Baru',
				'{25}': 'Mendaftarkan jadwal baru pemeliharaan aset',
				'{26}': 'Kembali',
				'{27}': 'Kembali ke laman depan pemeliharaan',
				'{28}': 'Simpan',
				'{29}': 'Simpan data pemeliharaan ini',
				'{30}': 'Ulangi',
				'{31}': 'Ulangi pengisian data pemeliharaan aset'
			},
			'doc-assetreq': {
				'{0}': 'Permintaan Aset',
			...
			'doc-assetout': {
				'{0}': 'Perpindahan Aset',
				'{1}': 'Buat Baru',
				'{2}': 'Ringkasan Permintaan Aset Keluar',
				'{3}': 'Form Aset Keluar',
				'{4}': 'Jumlah Dokumen Aset',
				'{5}': 'Jumlah Dokumen Menunggu Persetujuan',
				'{6}': 'Ditolak / Disetujui / Selesai',
				'{7}': 'Perbarui',
				'{8}': '#',
				'{9}': 'No. Dokumen',
				'{10}': 'Tgl. Pembuatan',
				...
				'{15}': 'Tanggal',
				'{16}': 'Lokasi Asal',
				'{17}': '--- Pilih Lokasi Asal ---',
				'{18}': 'Lokasi Tujuan',
				'{19}': '--- Pilih Lokasi Tujuan ---',
				'{20}': 'Remark',
				'{21}': 'Tambah Aset',
				'{22}': 'Cari Aset',
				'{23}': 'Kode',
				...
				'{28}': 'Simpan',
				'{29}': 'Ulangi',
				'{30}': 'Menambahkan aset yang akan dipindah',
				'{31}': 'Muat file CSV',
				'{32}': 'Tambahkan aset melalui file CSV'
			},
			'doc-assetproc': {
				'{0}': 'Permintaan Aset Baru',
				'{1}': 'Permintaan Baru',
				'{2}': 'Ringkasan',
				'{3}': 'Pengadaan',
				'{4}': 'Dokumen Penunggu Persetujuan',
				'{5}': 'Dokumen Disetujui',
				'{6}': 'Dokumen Ditolak',
				'{7}': 'Perbarui',
				'{8}': '#',
			...
			'file-manager': {
				...
				'{24}': 'Tipe Data Induk',
				'{25}': 'Pilih File',
				'{26}': 'Klik untuk mulai mengunggah file',
				'{27}': 'Arahan Pengunggahan File Master Data Pertama Kali',
				'{28}': 'Unggah master data lokasi terlebih dahulu jika belum ada data lokasi',
				'{29}': 'Unggah master data sublokasi jika sudah mengunggah data lokasi',
				'{30}': 'Unggah master data atribut kategori/konfigurasi item sebelum melakukan pengunggahan master data kategori item',
				'{31}': 'Unggah master data kategori/konfigurasi item setelah master data attribute telah selesai diunggah',
				'{32}': 'Pastikan master data lokasi, sublokasi, kategori item dan atribut kategori telah berhasil terunggah sebelum memulai pengunggahan master data item aset ke basis data',
				'{33}': 'Unggah master data item aset jika semua master data poin 1-4 telah diunggah ke dalam basis data',
				'{34}': 'Unggah master data detail item aset setelah master data item aset telah berhasil di unggah ke dalam basis data',
				'{35}': 'Selamat! Anda siap untuk menggunakan sistem manajemen aset ini.',
				'{36}': 'Tabel Gambar',
				'{37}': 'Hapus Gambar',
				'{38}': 'Pilih gambar terlebih dahulu sebelum anda dapat melakukan unggahan!'
			}
		}
	};
