            				...
            				<div class="card-body">
            					<div class="row">
            						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
            							...
            							<form id="form-login" action="<?php echo isset ($formAction) ? $formAction : ''; ?>" method="post">
            								<div class="form-group">
            									...
            									<div class="input-group">
            										...
            										<input type="text" name="input-username" class="form-control" placeholder="<?php echo isset ($text) ? $text : 'e.g. john.doe or john.doe@someemail.com'; ?>" required="required" />
            									</div>
            								</div>
            								...
            								<div class="form-group">
            									...
            									<div class="input-group">
            										...
            										<input type="password" name="input-password" class="form-control" placeholder="<?php echo isset ($text) ? $text : 'Type Your Password'; ?>" required="required" />
            									</div>
            								</div>
        						...
        						<div class="card-message text-center text-muted">
        							<?php echo isset ($text) ? $text : 'Not registered? Please contact system administrators'; ?> <a href="#">here</a>
        						</div>
            				</div>
            			</div>
        			</div>
