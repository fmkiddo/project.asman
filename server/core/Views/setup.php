			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card shadow">
					<div class="card-body">
						...
						<div class="row">
							<div class="col-xl-4 col-lg-4 col-md-4 form-left-side"></div>

							<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
								<form role="form" id="form-setup" method="post"
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" name="input-new-username"
												class="form-control"
												placeholder="<?php echo isset ($text) ? $text : 'e.g. johndoe123'; ?>"
												required="required" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="email" name="input-new-email"
												class="form-control"
												placeholder="<?php echo isset ($text) ? $text : 'jhon.doe@someemail.com'?>"
												required="required" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="password" name="input-new-password"
												class="form-control"
									...
									<div class="form-group">
										...
										<div class="input-group">
											<div class="input-group-prepend">
												<span class="input-group-text"> <i class="fas fa-redo fa-fw"></i>
												</span>
											</div>
											<input type="password" name="input-confirm-password"
												class="form-control"
												placeholder="<?php echo isset ($text) ? $text : 'Re-type Your Password'; ?>"
												required="required" />
										</div>
									</div>
										...
										<div class="col">
											<div
												class="alert alert-<?php echo isset ($errors) ? 'danger' : (isset ($success) ? 'success' : ''); ?>">
        												<?php echo isset ($errors) ? $errors : (isset ($success) ? $success : ''); ?>
										...
										<div class="col">
											<button type="submit" class="btn btn-primary btn-block"
												title="<?php echo isset ($text) ? $text : 'Submit Your Data'; ?>">
										...
										<div class="col">
											<button type="reset"
												...
												title="<?php echo isset ($text) ? $text : 'Reset Form'; ?>">
						...
						<div class="card-message text-center text-muted">
        							<?php echo isset ($text) ? $text : 'Do you have troubles? please contact administrators'; ?> <a
								href="#">here</a>
						</div>
					</div>
				</div>
